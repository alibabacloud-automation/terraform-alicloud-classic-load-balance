...
resource "alicloud_vswitch" "vswitches" {
  ...
  zone_id    = length(var.availability_zones) > 1 ? var.availability_zones[count.index] : data.alicloud_db_instance_classes.default.instance_classes[0].zone_ids[count.index % length(data.alicloud_db_instance_classes.default.instance_classes[0].zone_ids)]["id"]
...
resource "alicloud_slb_load_balancer" "intranet" {
